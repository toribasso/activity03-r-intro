...
**Response**:These errors were focused on making sure there were commas
after each character and that there were quotation marks at the
...
**Response**: I found that the data frame function was incorrect to use
and that the symbol was on the wrong side of the equal sign.
